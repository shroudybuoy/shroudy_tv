                    ...
                    child: const SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 6),
                          Text("NOW • EPG available on launch", style: TextStyle(color: Colors.grey, fontSize: 12)),
                          SizedBox(height: 12),
                          Text("System connecting stream rendering views cleanly.", style: TextStyle(color: Colors.grey, fontSize: 12)),
                        ],
                      ),
                    ),
                  ),
...
// ============================================================
// NATIVE CORE STREAM LAYER CANVAS (BYPASSES CODE-SIGNING BLOCKS)
// ============================================================
        ...
        children: [
          Positioned.fill(
            child: Container(
              color: Colors.black,
              child: UiKitView(
                viewType: 'shroudy_tv_native_canvas_view',
